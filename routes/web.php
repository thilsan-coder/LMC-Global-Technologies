...
Route::get('/services/{service:slug}', [PublicController::class, 'serviceDetail'])->name('public.services.show');
Route::get('/products', [PublicController::class, 'products'])->name('public.products');
Route::get('/products/{product:slug}/architecture', [PublicController::class, 'productArchitecture'])->name('public.products.architecture');
Route::get('/reviews', [PublicController::class, 'reviews'])->name('public.reviews');
Route::get('/reviews/create', [PublicController::class, 'createReview'])->name('public.reviews.create');
